...
use crate::{indcpa::*, params::*, symmetric::*, verify::*};
...
//              - [u8] temp_key:       output shared secret (an already allocated array of CRYPTO_BYTES bytes)
    ...
    R: RngCore + CryptoRng,
{
    ...
    kdf(temp_key, &kr, 2 * KYBER_SYMBYTES);
}
